    ...
    private void readDataFile(String fileName)
        ...
        while (file.hasNextLine()) {
            ...
            if (tokenCount == 10) {
                ...
                int views = Integer.parseInt(tokens[8]); 
                
                Channel c = new Channel(username, channelName, country, mainTopic, likes, posts, followers, comments, views); 
                if (mName.equals("January")) { 
                    months[0].addChannel(c); 
                } else if (mName.equals("Febuary")) { 
